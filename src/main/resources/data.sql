...
insert into credencial_autorizacoes values (1,2);
...
insert into oauth_client_details (client_id,client_secret,authorized_grant_types,access_token_validity,refresh_token_validity,web_server_redirect_uri,resource_ids,scope,scoped,secret_required,autoapprove) values ('first-client', '$2y$04$rQ.nyRuINjsHn9OCBKr5vO4lLu9Ktxo6NP5HI3UjASyHlmvPSZsdm', 'authorization_code', 36000, 36000, 'http://localhost:8081/', null, 'read', true, true, true);
